...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Author'
        db.create_table(u'zinnia_author', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('zinnia', ['Author'])


    def backwards(self, orm):
        # Deleting model 'Author'
        db.delete_table(u'zinnia_author')
    ...
    models = {
        ...
        'zinnia.entry': {
            ...
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'entries'", 'blank': 'True', 'to': "orm['zinnia.Author']"}),
